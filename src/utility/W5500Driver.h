...
class W5500CallbackDriver : public W5500Driver {
public:

  W5500CallbackDriver(uint16_t poll_interval_ms = 60, uint32_t sw_reset_timeout_ms = 300)
      : W5500Driver(-1, -1, -1), poll_interval(poll_interval_ms > 0 ? poll_interval_ms : 60), sw_reset_timeout(sw_reset_timeout_ms > 0 ? sw_reset_timeout_ms : 300) {
  }
